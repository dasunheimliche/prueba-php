                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-12">
                            <div class="site-logo">
                                <a href="index.php" class="main-logo"><img src="img/logo.png" alt="Site Logo"></a>
                                <a href="index.php" class="sticky-logo"><img src="img/sticky-logo.png" alt="Site Logo"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 d-none d-lg-flex align-items-center justify-content-end">
                            <div class="nav-action-elements">
                                <ul>
                                    ...
                                    <li>
                                        <a href="add-listing.php" class="ghost-btn"><i class="fas fa-plus"></i>ADD LISTING</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
