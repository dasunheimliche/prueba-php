...
<head>
    ...
    <title>Listygo | Listing Grid View 5</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group stylish-input-group">
                                            <input type="text" placeholder="cafe, shoppingmall, beauty &amp; spa ..."
                                                class="form-control" name="website" id="form-website" data-error="Search text required"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group stylish-input-group">
                                            <input type="email" placeholder="Type here city or locaion" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control rt-date" placeholder="Date" name="date"
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <ul class="contact-info">
                                                    <li><i class="fas fa-map-marker-alt"></i>59 Street, Mk tower,
                                                        Brooklyn</li>
                                                ...
                                                <ul class="meta-item">
                                                    ...
                                                    <li class="entry-meta">
                                                        <ul>
                                                            ...
                                                            <li class="tooltip-item" data-tips="Gallery"><a href="#"><i
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <ul class="meta-item">
                                                    ...
                                                    <li class="entry-meta">
                                                        <ul>
                                                            <li class="tooltip-item ctg-icon" data-tips="Shopping"><a
                                                                    href="#"><i class="flaticon-supermarket"></i></a></li>
                                                            <li class="tooltip-item" data-tips="My Favourite"><a href="#"><i
                                                                        class="fas fa-heart"></i></a></li>
                                                            <li class="tooltip-item" data-tips="Gallery"><a href="#"><i
                                                                        class="far fa-image"></i></a></li>
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <ul class="meta-item">
                                                    ...
                                                    <li class="entry-meta">
                                                        <ul>
                                                            <li class="tooltip-item ctg-icon" data-tips="Nightlife"><a
                                                                    href="#"><i class="flaticon-musical-note"></i></a></li>
                                                            <li class="tooltip-item" data-tips="My Favourite"><a href="#"><i
                                                                        class="fas fa-heart"></i></a></li>
                                                            <li class="tooltip-item" data-tips="Gallery"><a href="#"><i
                                                                        class="far fa-image"></i></a></li>
