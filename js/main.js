(function ($) {
  ...
  /*-------------------------------------
    ...
    -------------------------------------*/
  $(document)
    .on("mouseover", ".tooltip-item", function () {
      var self = $(this),
        tips = self.attr("data-tips");
      $tooltip =
        '<div class="listygo-tooltip">' +
        '<div class="listygo-tooltip-content">' +
        tips +
        "</div>" +
  ...
  /*-------------------------------------
    ...
    -------------------------------------*/
  if (
    $("header .header-main").length &&
    $("header .header-main").hasClass("header-sticky")
  ) {
    ...
    $(window).on("scroll load", function (event) {
      ...
      if (st > lastScroll && st > header_position.top) {
        $(".header-table").length
          ? $("header .header-table").addClass("hidden-menu")
          : $("header .header-main").addClass("hidden-menu");
      } else if (st <= lastScroll) {
        $(".header-table").length
          ? $("header .header-table").removeClass("hidden-menu")
