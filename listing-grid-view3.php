...
<head>
    ...
    <title>Listygo | Listing Grid View 3</title>
                    ...
                    <div class="order-lg-1 col-lg-4 sidebar-widget-area sidebar-break-md">
                        <div class="widget widget-box-padding widget-filter">
                            ...
                            <div class="input-group stylish-input-group">
                                <input type="text" placeholder="What are you looking for ..." class="form-control" name="website"
                                    id="form-website" data-error="Search text required" required>
                            ...
                            <div class="input-group stylish-input-group">
                                <input type="email" placeholder="Locations" class="form-control" name="email" id="form-email"
                                    data-error="Category name is required" required>
                                <span class="input-group-addon">
                                    <button type="submit">
                            ...
                            <div class="input-group">
                                <select class="select2" name="filter-by">
                                    ...
                                    <option value="1">Sopping Mall</option>
                            ...
                            <div class="inline-box">
                                <div class="checkbox checkbox-primary">
                                    ...
                                    <label for="checkbox1">Open Now</label>
                                </div>
                                <div class="checkbox checkbox-primary">
                                    <input id="checkbox2" type="checkbox">
                                    <label for="checkbox2">Top Rating</label>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-box-padding widget-latest-article">
                            ...
                            <ul class="block-list">
                                <li class="single-item">
                                    <h4 class="item-title"><a href="#">Summer Crop Nutritionertilizer Requirements</a></h4>
